...
public class MainDashboard extends JFrame {
    ...
    private JPanel createTopPanel() {
        ...
        // Show deadline only for Students
        if (session.isStudent()) {
            String deadline = accessChecker.getRegistrationDeadline();
            JLabel deadlineLabel = new JLabel("Registration Deadline: " + deadline);
            deadlineLabel.setForeground(Color.BLUE);
        ...
        // CENTER: Maintenance Mode Banner
